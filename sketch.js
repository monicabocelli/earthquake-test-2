...
function draw(){
   ...
   var magnitude = int(map(value, 0, 10000, 0, 10)); // messo in setup il valore di magnitude è fisso e si vedono i pallini
...
function deviceShaken(){
    ...
    value = (pAccelerationX * pAccelerationY * pAccelerationZ)/1000;   
